...
router.get('/basicinfo/:id', async (req, res) => { // get the basic info of the user
    const id = req.params.id; // grab the id from the request parameters

    const basicInfo = await Users.findByPk(id, { // find the user with the id
